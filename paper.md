...
The hypergraphs and simplicial complexes may be modified by adding or removing nodes and adding or removing hyperedges or simplices. XGI also provides functions for more complex manipulations such as swapping node and edge memberships.
